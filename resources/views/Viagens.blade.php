...
@section('content')
  ...
  <div class="album py-5">
    <div class="container">
      <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3"><br>
        <!-- inicio do card -->
        @foreach($presentes as $banco)

          <div class="col">
            <div class="card shadow-sm">
                <img src= "/img/album/{{ $banco->image }}" width="100%" height="100%" fill="#fafcfd" style="border-radius: 13px;">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                      <small class="text-muted">{{ date('d/m/y', strtotime($banco->dia)) }}</small><small class="text-muted">{{ $banco->descricao }}</small>
                    </div>
                  </div>
                </div>
            </div>
